		...
		<div className="bg-white">
			...
			<main>
				...
				<div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
					<div className="relative isolate overflow-hidden bg-gray-900 px-6 py-16 sm:rounded-3xl sm:px-10 sm:py-20 lg:py-20 xl:px-20">
							...
							<div className="lg:pr-8 lg:pt-4">
								<div className="lg:max-w-lg">
									...
									<p className="mt-6 text-lg leading-8 text-gray-300">
										...
										medical records in one secure place. In an emergency,
										trusted first responders can quickly access critical details
										from your medical history. We're here to help save lives,
										one at a time.
									</p>
									<div className="mt-10 flex items-center gap-x-6">
										<a
